export const LearnLocalLogo = () => (
	<img
    src='/logo.png' // Replace '/logo.png' with the correct path to your image file in the public folder
    alt='LearnLocal'
    style={{
      height: '29px',
      width: '103px',
...
export const LearnLocalMobileLogo = () => (
	<img
    src='/favicon.ico' // Path to your image file in the public folder
    alt='LearnLocal'
    style={{
      height: '24px',
      width: '24px',
